            ...
            <div className={`flex flex-col ${this.props.type === 'Release' ? 'bg-gray' : 'bg-base-gray'} w-60 md:w-80 rounded-xl md:rounded-2xl`}>
                <div className='px-2 md:px-4 py-4 md:py-8'>
                    ...
                    <div className='flex flex-row rounded-md download-button bg-base-gray justify-center text-center border border-light-green'>
                        <a className='flex flex-row px-3 md:px-4 py-1 md:py-2 text-4 font-bold text-light-green font-functional items-center' href={this.props.url} target='_blank' rel='noreferrer'>
                            DOWNLOAD NOW
